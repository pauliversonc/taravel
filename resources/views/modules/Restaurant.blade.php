...
<div class="home">
		<div class="background_image" style="filter:blur(2px);  background-image:url({{asset('storage/hdpics/Sinulog.jpg')}})"></div>
	</div>
	<!-- Search -->
...
<div class="container">
        ...
        <div class="row" style="border:2px solid black; padding: 10px; border-radius: 8px;">
                ...
                <div class="sidebar_title">Region</div>
                    ...
                    <ul>
                        ...
                        <li><div class="d-flex flex-row align-items-start justify-content-start"> <input type="checkbox" name="filter_region[]" value="{{$re->id}}">{{$re->name}}</div></li>
                        @endforeach
                        <br>
                    </ul>
                </div>
    ...
    <div class="news">
            ...
            <div class="container">
                                ...
                                <div class="sorting">
                                    <ul class="item_sorting">
                                        <li>
                                            ...
                                            <ul>
                                                <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "original-order" }'><a href="{{url('/taravel/restaurant')}}"><span>Default</span></a></li>
                                                <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "price" }'><a href="{{url('/taravel/restaurant/1')}}"><span>Price Asc.</span></a></li>
                                                <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "name" }'><a href="{{url('/taravel/restaurant/2')}}"><span>Price Desc.</span></a></li>
                                                <li class="product_sorting_btn" data-isotope-option='{ "sortBy": "view" }'><a href="{{url('/taravel/restaurant/3')}}"><span>Most views</span></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row"  style="border:2px solid black; padding: 10px; border-radius: 8px;">
                        <h4 class="sidebar_title">Restaurants</h4>
                    <!-- News Container -->
                    <div class="col-lg-12">

                            <?php $ratecount=0;?>
                            @foreach ($data->where('business_type_id',2) as $k => $item)
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="card-text">
                                                ...
                                                @endforeach
                                                ({{number_format($item->total,1)}}) Rating {{$item->business_address}} <br>
                                                <form action="{{url('tag')}}" method="get" enctype="multipart/form-data">
                                                    {{csrf_field()}}   Tags:
                                                ...
                                                {{$item->business_website}} <br>{{$item->business_number}}<br> {{ str_limit($item->attraction_details, $limit = 100, $end = '...') }}</p>
                                                <div class="news_post_link" style="margin-top:0px;"><a href="{{url('get/details/'.$item->id)}}">Read More</a></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="card-block px-2">
                                                ...
                                                <p class="card-text"><i class="fas fa-eye" style="color:tomato;"></i> {{$item->total}} <br>
                                                    ...
                                                    </form> {{$item->business_address}}<br> {{$item->business_website}} <br>{{$item->business_number}}<br> {{ str_limit($item->attraction_details, $limit = 100, $end = '...') }} </p>
                                                <div class="news_post_link" style="margin-top:0px;"><a href="{{url('get/details/'.$item->id)}}">Read More</a></div>
                                            </div>
                                        </div>
